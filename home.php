    ...
    <body id="page-top">
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.tkrec.ac.in/">Teegala Krishna Reddy Engineering College</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 ftr_navi ftr-Copyright & copy; 2021 TKREC | Developed by">
					<h3>Copyright &copy; 2021 TKREC | Developed by</h3>
						<p>Chakri</p>
						<p>Aishwarya</p>
						<p>Vamsi</p>
						<p>Namatha</p>
