				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">TKREC<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Our Institute is located near HYDERABAD, a well known place of learning. Our college is affiliated to JNTUH (TELANGANA), recognized by AICTE, New Delhi, & by Government of TELANGANA. 
						</p>
					</div>
			...
			<div class="banner-bottom-grids a-banner-bottom-grids">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
						...
						<h5></span></h5>
						<p> ur Institute is located near HYDERABAD, a well known place of learning. Our college is affiliated to JNTUH (TELANGANA), recognized by AICTE, New Delhi, & by Government of TELANGANA. 
						</p>
					</div>
